...
class PlutoGridStyleConfig {
  ...
  PlutoGridStyleConfig copyWith({
    ...
    return PlutoGridStyleConfig(
        ...
        enableGridBorders: enableGridBorders ?? this.enableGridBorders,
        ...
        cellColorGroupedRow:
            cellColorGroupedRow == null ? this.cellColorGroupedRow : cellColorGroupedRow.value,
        ...
        columnAscendingIcon:
            columnAscendingIcon == null ? this.columnAscendingIcon : columnAscendingIcon.value,
        columnDescendingIcon:
            columnDescendingIcon == null ? this.columnDescendingIcon : columnDescendingIcon.value,
  ...
  bool operator ==(covariant Object other) {
    return identical(this, other) ||
        other is PlutoGridStyleConfig &&
            ...
            enableGridBorders == other.enableGridBorders &&
  ...
  PlutoGridColumnSizeConfig copyWith({
    ...
    return PlutoGridColumnSizeConfig(
      ...
      restoreAutoSizeAfterFrozenColumn:
          restoreAutoSizeAfterFrozenColumn ?? this.restoreAutoSizeAfterFrozenColumn,
      ...
      restoreAutoSizeAfterInsertColumn:
          restoreAutoSizeAfterInsertColumn ?? this.restoreAutoSizeAfterInsertColumn,
      restoreAutoSizeAfterRemoveColumn:
          restoreAutoSizeAfterRemoveColumn ?? this.restoreAutoSizeAfterRemoveColumn,
    );
  }
